...
const ROOF_BATTEN_FAQS = [
  ...
  },
  {
    ...
    a: "เลือกตามน้ำหนักแผ่นหลังคาและระยะห่างจันทัน ยิ่งจันทันห่าง ยิ่งต้องใช้แปหนาขึ้น | 0.50 มม. งานคุมงบ หลังคาเบา เช่น โรงเรือน เพิงพัก | 0.55 มม. ความหนามาตรฐาน ใช้ได้กับงานต่อเติม กันสาด และบ้านพักอาศัยทั่วไป | 0.70 มม. จันทันห่างขึ้น หรือมีคนขึ้นเดินบนหลังคาบ่อย | 0.85 มม. งานโรงงาน โกดัง อาคารช่วงกว้าง ที่ต้องการลดจำนวนจันทัน | 1.00 มม. (เฉพาะรุ่นอลูซิงค์) โครงสร้างหลังคาที่รับน้ำหนักสูงสุด | หากไม่แน่ใจ ส่งแบบหรือระยะจันทันมาที่ Line @kaistandard ให้ทีมช่วยเลือกให้",
  },
  {
    q: "ระยะห่างแปหลังคา ควรเว้นกี่เซนติเมตร?",
    a: "ระยะห่างแปขึ้นอยู่กับวัสดุมุงหลังคาเป็นหลัก ไม่ได้ขึ้นกับความหนาของแป กระเบื้องลอนคู่ยาว 120 ซม. วางแปห่าง 100 ซม. กระเบื้องลอนคู่ยาว 150 ซม. วางแปห่าง 130 ซม. และแปตัวสุดท้ายด้านบนควรห่างจากปลายจันทัน 5 ซม. ส่วนหลังคาเมทัลชีท ระยะขึ้นกับความหนาแผ่นและองศาหลังคา แนะนำสอบถามทีมงานก่อนวางแป วางแปถี่เกินไปจะเปลืองของ วางห่างเกินไปหลังคาจะแอ่นและเสี่ยงรั่วตรงรอยต่อ",
  },
  {
...
const CILAI_FAQS = [
  {
    q: "ซีลายยาวกี่เมตร?",
    a: "ซีลาย หรือ ซีไลน์ (C-Line) ของไคสแตนดาร์ด ยาว 4 เมตรต่อเส้น ทั้งเบอร์ 24 และเบอร์ 26 รุ่นตราช้าง (SCG) ก็ยาว 4 เมตรเช่นกัน",
  },
  {
    q: "ซีลายเบอร์ 24 กับเบอร์ 26 ต่างกันอย่างไร?",
    a: "เบอร์ 24 หนากว่าและแข็งแรงกว่า น้ำหนัก 0.80-0.85 กก./เส้น รับน้ำหนักแผ่นฝ้าได้ดีกว่า ราคา 36 บาท ส่วนเบอร์ 26 เบากว่าและประหยัดกว่า น้ำหนัก 0.60-0.65 กก./เส้น ราคา 32 บาท เหมาะกับงานที่ต้องการคุมงบ (ซีไลน์เบอร์ 24 กับ ซีลายเบอร์ 24 คือตัวเดียวกัน แค่คนเรียกและสะกดต่างกัน)",
  },
  {
    q: "ซีลายราคาเท่าไหร่?",
    a: "ซีลาย หรือ ซีไลน์ เบอร์ 26 ราคา 32 บาท/เส้น และเบอร์ 24 ราคา 36 บาท/เส้น (ยังไม่รวม VAT 7%) ถ้าต้องการรุ่นตราช้าง SCG มี ซีลายพลัสลายน์ ราคา 54 บาท และ ซีลายโปรลายน์ ราคา 80 บาท งานโครงการมีราคาพิเศษ สอบถามโทร 02-415-3676 หรือ Line @kaistandard",
  },
  {
    q: "ซีลายใช้คู่กับอะไร?",
    a: "ซีลายหรือซีไลน์ ใช้คู่กับฉากริม 1 นิ้ว ยาว 2.40 เมตร ราคา 16 บาท เพื่อยึดขอบฝ้าเข้ากับผนัง ทำให้ได้ระบบฝ้าเพดานฉาบเรียบครบชุด ถ้าเลือกรุ่นตราช้าง SCG ใช้คู่กับโครงริมพลัส ราคา 20 บาท หรือ โครงริมโปร ราคา 29.75 บาท ตามเบอร์ที่เลือก",
  },
];
