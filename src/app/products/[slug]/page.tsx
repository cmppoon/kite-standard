...
const tbarApplications = [
  { title: "บ้านพักอาศัย", text: "ลดเสียงก้องในห้องนั่งเล่นและห้องทำงาน พร้อมลวดลายปรุที่เพิ่มมิติให้ฝ้าเพดาน" },
  { title: "ห้องประชุม / สำนักงาน", text: "ลดเสียงสะท้อนในห้องประชุมและออฟฟิศ ทำให้การพูดคุยฟังชัดขึ้น" },
  { title: "โรงพยาบาล / คลินิก", text: "ช่วยคุมเสียงก้องในพื้นที่ให้บริการ สร้างบรรยากาศเงียบสงบ" },
  { title: "ห้างสรรพสินค้า / ร้านสะดวกซื้อ", text: "ฝ้าปรุลายลดเสียงก้องในพื้นที่ค้าปลีก พร้อมลุคเพดานที่ดูทันสมัย" },
];
